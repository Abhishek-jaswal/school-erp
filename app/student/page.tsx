...
export default function StudentDashboard() {
  ...
  const sectionComponent = useMemo(() => {
    ...
    switch (section) {
      case 'profile':
        return <ProfileSection student={student} />;
      case 'syllabus':
        return <SyllabusView subject={student.subject} />;
      case 'exams':
        return <ExamView student={student} />;
      case 'issue':
        return <IssueForm role="student" userId={student.id} />;
      case 'notification':
